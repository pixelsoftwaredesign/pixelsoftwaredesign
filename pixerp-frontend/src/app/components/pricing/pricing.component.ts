...
@Component({
  ...
  styles: [`
    ...
    .page-header h2 { margin: 0; font-size: 2rem; color: #134e4a; }
    ...
    .plan h3 { margin: 0; font-size: 1.3rem; color: #134e4a; }
    .plan-desc { margin: 5px 0 20px; font-size: 0.85rem; color: #6b7280; }
    .price { margin-bottom: 25px; }
    .amount { font-size: 2.5rem; font-weight: 800; color: #134e4a; }
    ...
    .btn-plan:hover { border-color: #0d9488; color: #0d9488; }
    .btn-plan.current { border-color: #0d9488; color: #0d9488; cursor: default; }
